...
public class HttpCustomClient {
     ...
     * @throws Exception
     */
    public String doPost(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
...
//        logger.info("request body:" + requestBody);
    ...
    private String getResult(HttpRequestBase httpRequest) throws Exception {
