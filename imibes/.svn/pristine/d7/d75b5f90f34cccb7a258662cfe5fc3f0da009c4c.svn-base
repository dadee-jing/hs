...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/logo-little.png**", "anon");
        ...
        filterChainDefinitionMap.put("/tic/**", "anon");
        filterChainDefinitionMap.put("/shunde/**", "anon");
        filterChainDefinitionMap.put("/module/stationInfo/**", "anon");
